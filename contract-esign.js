...
(function setupSignature(){
  ...
  wrap.innerHTML = '<div style="font-size:9pt;margin-bottom:8px;"><label style="cursor:pointer;"><input type="checkbox" id="esign-consent" style="vertical-align:middle;"> <strong>Buyer agrees to sign this contract electronically. / El Comprador acepta firmar este contrato de forma electronica.</strong></label></div><div style="font-size:8pt;color:#555;margin-bottom:4px;">Sign below with finger or stylus / Firme abajo con el dedo o lapiz:</div><canvas id="esign-pad" width="760" height="260" style="border:1px solid #999;border-radius:6px;background:#fff;touch-action:none;-webkit-user-select:none;user-select:none;-webkit-touch-callout:none;width:100%;display:block;"></canvas><div style="font-size:8pt;color:#555;margin:10px 0 4px;">Buyer initials / Iniciales del comprador:</div><canvas id="esign-initials" width="220" height="90" style="border:1px solid #999;border-radius:6px;background:#fff;touch-action:none;-webkit-user-select:none;user-select:none;-webkit-touch-callout:none;max-width:100%;display:block;"></canvas><button type="button" id="esign-clear" style="font-size:8pt;background:transparent;border:1px solid #999;border-radius:5px;padding:4px 12px;margin-top:6px;cursor:pointer;">Clear / Limpiar</button>';
  ...
  function makePad(cv){
    ...
    cv.addEventListener('pointerdown',function(e){ drawing=true; var q=pos(e); lx=q.x; ly=q.y; try{var _s=window.getSelection&&window.getSelection();if(_s&&_s.removeAllRanges)_s.removeAllRanges();}catch(_e){} e.preventDefault(); });
