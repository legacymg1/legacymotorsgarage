...
function clearNotifs(){ try{ if('serviceWorker' in navigator) navigator.serviceWorker.ready.then(r=>{ if(r.getNotifications) r.getNotifications().then(ns=>ns.forEach(n=>n.close())).catch(()=>{}); }).catch(()=>{}); }catch(e){} }
